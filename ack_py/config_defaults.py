"""Default configuration for ack — directories/files to ignore and filetype definitions.

Ported from lib/App/Ack/ConfigDefault.pm.
"""
...
def options() -> list[str]:
    return _OPTIONS_BLOCK.format(version=ack_py.__version__).split("\n")
